...
export default function NewStudentPage() {
  ...
  const [form, setForm] = useState({ name: "", age: "", grade: "", region: "Gedo", district: "", village: "", story: "", imageUrl: "", storyImageUrl: "", goalAmount: "" });
      ...
      <div style={{ backgroundColor: "#161b22", border: "1px solid #21262d", borderRadius: 12, padding: "28px 32px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            ...
            <ImageUpload value={form.storyImageUrl} onChange={(url) => setForm((f) => ({ ...f, storyImageUrl: url }))} label="Profile Photo (visible)" />
          </div>
